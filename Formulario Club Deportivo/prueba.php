...
$sql = "SELECT * FROM usuarios 
        WHERE rol='socio' AND (nombre LIKE :q OR telefono LIKE :q)";
    ...
    <div class="socio-card">
        ...
        <?php if ($editando && $editando['id'] == $socio['id']): ?>
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                Nombre:<br>
                <input type="text" name="nombre" value="<?= htmlspecialchars($editando['nombre']) ?>"><br><br>

                Edad:<br>
                <input type="number" name="edad" value="<?= htmlspecialchars($editando['edad']) ?>"><br><br>

                Teléfono:<br>
                <input type="text" name="telefono" value="<?= htmlspecialchars($editando['telefono']) ?>"><br><br>
